...
class Employee:
    def _init_(self, root):
        ...
        # img logo
        img_logo = Image.open('F:/Python/Project/empimages/logo1.jpg')
        ...
        # empimg1
        img_1 = Image.open('F:/Python/Project/empimages/empimg7.png')
        ...
        # empimg2
        img_2 = Image.open('F:/Python/Project/empimages/empimg6.png')
        ...
        # empimg3
        img_3 = Image.open('F:/Python/Project/empimages/empimg5.png')
            ...
            try:
                ...
                if Delete > 0:
                    conn = mysql.connector.connect(user='root', password='*********', host='127.0.0.1', port='3306',
                                                   database='employee_form', auth_plugin='mysql_native_password')
                    my_cursor = conn.cursor()
